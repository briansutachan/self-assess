/* 1. Use an if statement to double the variable num if num is greater than 2. */
let num = 4;
let a;
if(num > 2) {
        a = num * 2
...
/* 2. Use an if statement to double the variable newNum if newNum is less than 3 */
let newNum = 2;
let n;
...
/* 3. Use an if statement to determine if num from Challenge 1 is even.  If it is, log true to the console.  Otherwise, log false to the console. */

if( )


/*4.You are given an array of elements called checkMe.  Use an if statement to log true if the length of the array is greater than 5, and false if it is not.
